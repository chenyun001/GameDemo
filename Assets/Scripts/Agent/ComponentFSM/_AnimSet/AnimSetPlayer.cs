...
public class AnimSetPlayer : AnimSet
{
    ...
    void Awake()
    {
        ...
        /*1*/
        AttackData[2] = new AnimAttackData("attackXXX", Trails.transform.Find("trail_XXX").gameObject, 0.7f, 0.25f, 0.20f, 0.30f, 0.366f, 10, 45, 0.75f, E_CriticalHitType.Horizontal, 0.3f, false, false, false, false);
        ...
        /*2*/
        AttackData[7] = new AnimAttackData("attackOOO", Trails.transform.Find("trail_OOO").gameObject, 1.0f, 0.5f, 0.36f, 0.55f, 0.6f, 15, 15, 1.0f, E_CriticalHitType.None, 0, false, true, false, false);
        ...
        /*4*/
        AttackData[11] = new AnimAttackData("attackXOO", Trails.transform.Find("trail_XOO").gameObject, 0.8f, 0.45f, 0.20f, 0.50f, 0.55f, 20, 15, 0.8f, E_CriticalHitType.None, 0, false, false, false, false);
        ...
        /*5*/
        AttackData[15] = new AnimAttackData("attackXXOX", Trails.transform.Find("trail_XXOX").gameObject, 1.0f, 0.41f, 0.11f, 0.55f, 0.60f, 20, 15, 0.7f, E_CriticalHitType.Vertical, 1, false, false, true, false);
        ...
        /*3*/
        AttackData[18] = new AnimAttackData("attackOOXO", Trails.transform.Find("trail_OOXX").gameObject, 0.7f, 0.6f, 0.2f, 0.6f, 0.7f, 20, 45, 0.7f, E_CriticalHitType.Vertical, 1.4f, false, false, false, false);
        ...
        /*6*/
        AttackData[21] = new AnimAttackData("attackOXO", Trails.transform.Find("trail_OXO").gameObject, 1.0f, 0.35f, 0.25f, 0.4f, 0.55f, 20, 90, 1, E_CriticalHitType.Horizontal, 0.5f, false, false, true, false);
